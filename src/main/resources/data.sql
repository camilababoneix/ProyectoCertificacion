...
INSERT INTO estudiante (rut, password,enabled, nombre, telefono,direccion,email,id_region,id_curso,edad) values ('203769611','$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.AQubh4a',1,'valentina', '98563248','Calle1','valentina@gmail.com',6,0,21);
INSERT INTO estudiante (rut, password,enabled, nombre, telefono,direccion,email,id_region,id_curso,edad) values ('188767052','$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.AQubh4a',1,'camila', '971921607','Calle2','camila.alvial.b@gmail.com',6,0,27);
INSERT INTO authorities (username, authority) values ('203769611','USER');
INSERT INTO authorities (username, authority) values ('203769611','ADMIN');
INSERT INTO authorities (username, authority) values ('188767052','USER');